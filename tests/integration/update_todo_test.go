...
func TestPutRequest(t *testing.T) {
	...
	badRequest, err := http.NewRequest(http.MethodPatch, "/todo-items/sometodoid", nil)
	...
	correctRequest, err := http.NewRequest(http.MethodPatch, "/todo-items/sometodoid", nil)
